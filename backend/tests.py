...
#         c = Card.objects.create(name='Snatch', text='If Snatch hits, draw a card')
#         c.save()
...
#         c1 = Card.objects.create(name='Snatch', text='If Snatch hits, draw a card')
#         c1.save()
#         with pytest.raises(IntegrityError, match='.* violates unique constraint .*'):
#             c2 = Card.objects.create(name='Snatch', text='If Snatch hits, draw a card')
#             c2.save()

#     def test_banned_card_create(self):
#         c = Card.objects.create(name='Snatch', text='If Snatch hits, draw a card', is_banned_cc=True, is_banned_blitz=True)
#         c.save()
...
#         k1.save()
#         c = Card.objects.create(name='Open the Center', text='')
#         c.save()
...
#         c2 = Card.objects.create(name='Head Jab', text='')
#         c2.save()
